...
angular.module('splain-app').controller('StartUrlCtrl', [
  '$scope',
  '$location',
  'settingsStoreSvc',
  'solrSettingsSvc',
  'esSettingsSvc',
  'osSettingsSvc',
  function ($scope, $location, settingsStoreSvc, solrSettingsSvc, esSettingsSvc, osSettingsSvc) {
    ...
    var runSolrSearch = function (overridingFieldSpec) {
      ...
      solrSettingsSvc.fromStartUrl(
        $scope.start.solrSettings.startUrl,
        $scope.start.solrSettings,
        overridingFieldSpec,
      );
      search();
    };
    ...
    $scope.start.autoIndent = function () {
      $scope.start.esSettings.searchArgsStr = JSON.stringify(
        JSON.parse($scope.start.esSettings.searchArgsStr),
        null,
        2,
      );
    };
