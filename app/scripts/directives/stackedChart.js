'use strict';
angular.module('splain-app').filter('stackChartColor', function () {
...
angular.module('splain-app').filter('stackChartHeight', function () {
  return function (input) {
    return { height: input + '%' };
  };
});

angular.module('splain-app').filter('stackChartLeftover', function () {
...
angular.module('splain-app').directive('stackedChart', function () {
  return {
    restrict: 'E',
    priority: 1000,
    scope: {
