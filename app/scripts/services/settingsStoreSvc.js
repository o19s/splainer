...
angular
  .module("splain-app")
  .service("settingsStoreSvc", function settingsStoreSvc(
    localStorageService,
    $location
  ) {
    this.ENGINES = {};
    ...
    var initSearchArgs = function() {
      ...
      searchSettings.solr.searchArgsStr = searchSettings.solr.searchArgsStr.slice(
        1
      );
      searchSettings.es.searchArgsStr = searchSettings.es.searchArgsStr.slice(
        1
      );
    ...
    var trySaveSolrArgs = function(searchSettings) {
      if (localStorageService.isSupported) {
        ...
        localStorageService.set(
          "solr_searchUrl",
          searchSettings.solr.searchUrl
        );
        localStorageService.set(
          "solr_fieldSpecStr",
          searchSettings.solr.fieldSpecStr
        );
        localStorageService.set(
          "solr_searchArgsStr",
          "!" + searchSettings.solr.searchArgsStr
        );
        ...
        localStorageService.set(
          "es_fieldSpecStr",
          searchSettings.es.fieldSpecStr
        );
        localStorageService.set(
          "es_searchArgsStr",
          "!" + searchSettings.es.searchArgsStr
        );
