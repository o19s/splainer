...
describe('startUrlCtrl', function() {
  ...
  it('bootstraps if es args in URL', function() {
    ...
    expect(scope.start.esSettings.startUrl).toBe(locationSvc.lastParams.esUrl);
    expect(localStorageSvc.get('es_startUrl')).toEqual(scope.start.esSettings.startUrl);
